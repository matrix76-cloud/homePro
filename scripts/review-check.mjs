...
// 사용: node scripts/review-check.mjs [YYYY-MM-DD] — 그 날짜 이후 올라온 리뷰 원글과 답글 유무 (기본 2026-08-14)
const since = new Date((process.argv[2] || '2026-08-14') + 'T00:00:00+09:00').getTime()
