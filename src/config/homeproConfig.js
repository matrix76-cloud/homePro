...
//  · 보라 #653A80 = 대표님 로고(파이코인)에서 뽑은 포인트 색 (9/17 확정, 시안 2번)
//  · 보라 #653A7D = 파이코인 아이콘에서 추출, 포인트로만 사용
export const THEME = {
    // 전부 초록 한 계열 — 대표 9/17 최종
    primary: "#00963F",        // 강조 (초록) — 활성 탭·선택 테두리·강조 글씨
    primaryLight: "#5FBE8A",   // 밝은 버전
    primaryDark: "#007A33",    // 어두운 버전 (흰 배경 위 텍스트·눌림 상태)
    button: "#00B84A",         // 주 버튼 면 (밝은 초록)
    ...
    purpleLight: "#E6F7EE",   // (레거시 키) 강조 연배경
    danger: "#EF4444",         // 위험/삭제
