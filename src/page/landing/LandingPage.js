 ...
 * - 디자인 토큰: 퍼플 주조색(#7C5CFC) + 흰/연회색 교차, 버튼 r10 / 카드 r16, 약한 그림자, 라인 아이콘
...
const FEATURES = [
  ...
  },
  {
    ...
    desc: '먼저 본 프로에게 우선배정, 여러 견적을 받아 비교, 믿는 프로에게 지정배정까지. 일의 급함과 신뢰도에 맞춰 선택합니다.',
    points: ['우선배정 · 다중비교 · 지정배정', '거부·블랙리스트로 안전하게', '완료 후 리뷰로 신뢰 쌓기'],
  },
  {
    Icon: FiCalendar,
    tag: '일정·채팅',
